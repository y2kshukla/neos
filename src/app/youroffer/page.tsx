...
const YourOffer = () => {
    return (
        <>
            ...
            <main
                className={`relative flex min-h-screen w-full flex-col items-center justify-center bg-center px-[5%] xl:max-w-6xl py-16`}
            >
                ...
                <div className='flex h-full w-full flex-col items-center gap-8 overflow-hidden rounded-xl rounded-t-none bg-background p-10'>
                    <Stepper />
                    <div className='flex w-full items-center justify-between'>
                        <div className='flex w-1/2 flex-col items-center justify-center gap-2'>
                            <div className='relative aspect-[436/490] w-full max-w-[436px]'>
                                <Image
